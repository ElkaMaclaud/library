...
class BookService {
    ...
    getBooks() {
        return __awaiter(this, void 0, void 0, function* () {
            const books = yield books_model_1.Book.find().select("-__v");
            return books;
        });
    }
    getBook(id) {
    ...
    updateBook(id, book) {
        return __awaiter(this, void 0, void 0, function* () {
            const newBook = yield books_model_1.Book.findByIdAndUpdate(id, book, { new: true, runValidators: true }).select("-__v");
            return newBook;
        });
    }
    deleteBook(id) {
